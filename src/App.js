...
CONSISTENCY RULE - VERY IMPORTANT: Your trade ideas and portfolio recommendations should stay consistent throughout the same trading day unless something material has changed. If no major news has broken, no significant price moves have happened, and no new catalysts have emerged since this morning, give the SAME trade ideas and recommendations as earlier today. Only change your recommendations if: (1) Breaking news directly affects a stock you recommended, (2) A position has hit its stop loss or target, (3) A major macro event has changed the market direction, (4) It is a new trading day with fresh data. Do not randomly generate new trade ideas just because the button was pressed again - stay with your conviction.\n\nSTOCK UNIVERSE: Scan the ENTIRE market for best opportunity. Primary: S&P 500 and Nasdaq. Also allowed: any US stock with strong catalyst AND 4+ quality gate factors, volume above 500K daily, price above 3 dollars. Find the single best risk/reward opportunity - mega-cap or lesser-known mid-cap. Diversify across sectors.";
};
